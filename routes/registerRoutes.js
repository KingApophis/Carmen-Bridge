...
router.post("/", async (req, res, next) => {
    ...
    if (firstName && lastName && username && email && password) { //checking if they all have values
        ...
        if (user == null) {
            ...
            else { //if it wasnt the email in use , then obviously it should be the username in use
